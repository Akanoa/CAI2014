...
5) Avant de deposer l'archive, VERIFIER qu'elle n'est pas vide et qu'elle contient les bons fichiers :
   ...
   resultat attendu :
     ...
     -rw-r--r-- dupond/dupond 1863 2014-09-01 16:50 Dupond-Dupont-Oscilloscope/vibration.py
...
Affichage et contrôle d'un signal (oscilloscope.py) :
 ...
 2) calcul de la courbe d'elongation (vibration.py)
 3) affichage de la courbe d'elongation (vibration.py, screen.py)
 4) sliders pour parametrer le signal en frequence, amplitude, phase  (vibration.py)
